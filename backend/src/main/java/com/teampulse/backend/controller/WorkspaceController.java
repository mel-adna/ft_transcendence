...
public class WorkspaceController {
	...
	@PostMapping
	public ResponseEntity<WorkspaceResponse> createWorkspace(@Valid @RequestBody WorkspaceCreateRequest request, Principal principal) {
	...
	public ResponseEntity<WorkspaceResponse> getWorkspaceById(@Parameter(description = "UUID of the workspace to fetch") 
	...
	public ResponseEntity<WorkspaceResponse> updateWorkspace(@Parameter(description = "UUID of the workspace to update")
															@PathVariable UUID workspaceId, @Valid @RequestBody WorkspaceUpdateRequest request,
															Principal principal) {
	...
	public ResponseEntity<Void> deleteWorkspace(@Parameter(description = "UUID of the workspace to delete") @PathVariable UUID workspaceId,
												Principal principal) {
	...
	public ResponseEntity<String> addMemberToWorkspace(@Parameter(description = "UUID of the workspace") @PathVariable UUID workspaceId,
	...
	public ResponseEntity<String> updateMemberRole(@Parameter(description = "UUID of the workspace") @PathVariable UUID workspaceId,
	...
	public ResponseEntity<String> deleteMemberFromWorkspace(@Parameter(description = "UUID of the workspace") @PathVariable UUID workspaceId,
